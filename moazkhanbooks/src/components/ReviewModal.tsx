      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="relative max-h-[85vh] w-full max-w-md overflow-y-auto rounded-md bg-card p-6 shadow-xl ring-1 ring-black/10"
          >
            <button
              type="button"
              onClick={handleClose}
            ...
            {status === "success" ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <motion.button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-sm bg-accent px-5 py-2.5 text-sm font-medium text-accent-foreground disabled:opacity-50"
                >
