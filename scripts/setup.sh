...
# Creates .env, MASTER_CONTEXT.md, and verifies API connectivity.
# Skills are already installed directly under .claude/skills/ — no sync step needed.
set -euo pipefail
...
echo ""
echo "Setup complete. Open this repo in Claude Code to start — skills live under .claude/skills/."
